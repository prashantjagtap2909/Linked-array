            ...
            <main>
                ...
                <div className='mt-14'>
                    ...
                    <form onSubmit={saveSocials} className='flex flex-col justify-center items-center'>
                        ...
                        <span className='flex flex-row mb-3 w-11/12 m-auto shadow-md border-2 px-3 py-2 rounded-md focus:outline-none'>
                            <img className='w-6 mr-2' src="/svg/hackr.svg" alt="" />
                            <input id='hackerrank' value={social.hackerrank} onChange={handleSocial} className='focus:outline-none w-full' type="text" placeholder="Enter Hackerrank ID" required/>
                        </span>
